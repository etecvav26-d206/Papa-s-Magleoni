    ...
    <body>
        <main class="admin-main">
            <section class="admin-head">
                <div>
                    <span class="logo-seal login-logo">
                        <img
                    ...
                    <p class="admin-kicker">Papa's Magleoni</p>
                    <h1>Acesso administrativo</h1>
                    <p>Entre para gerenciar pizzas, categorias e depoimentos.</p>
                </div>
            </section>
            <?php if (!$configured): ?>
